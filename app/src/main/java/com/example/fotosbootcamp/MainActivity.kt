...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pick_button.setOnClickListener {
            //Este if ira verificar se a versão de SDK do aparelho é maior que a versão que esta sendo usada no projeto
            //Caso for maior é necessario pedir a permissão
